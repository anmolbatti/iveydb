...
import heroDesktopBanner from "../assets/images/realestatemainbanner.jpg"
import heroMobileBanner from "../assets/images/interiorMobileBanner.jpg"
import startToFinishBanner from "../assets/images/realestatebanner.jpg"
import startToFinishBannerMobile from "../assets/images/realestatebannermobile.jpg"
...
const RealEstate = () => {
    return (
        <Layout>
                    ...
                    <div className='banner-content grid-blocks d-grid large-small gap-40 d-gap-100'>
                        <div className='grid-block'>
                            <div className='summary-block'>
                                <h6 className='mb-20 font-medium'>IVEY FOR REAL ESTATE</h6>
                                <h1 className='font-thin mb-20'>the construction and renovation firm for Miami’s luxury realtors</h1>
            ...
            <OurClientSlider />
            <div className='real-estate start-to-finish image-banner hero-banner large-screen position-relative color-light d-flex align-center pb-60'>
                <picture className="cover bottom-overlay position-absolute left-overlay top-0 start-0">
                    <source media="(max-width:768px)" srcSet={startToFinishBannerMobile} />
                    ...
                    <div className='banner-content grid-blocks d-grid'>
                        <div className='grid-block'>
                            <div className='summary-block'>
                                ...
                                <h2 className='font-thin mb-30'>turning an investment into a home</h2>
                                <div className='text-block'>We specialize in bringing interior designers’ visions to life with an attention to detail and adherence to timelines and a level of quality that matches the level of your design. </div>
                            </div>
                        </div>
                    </div>
